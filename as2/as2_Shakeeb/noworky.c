...
{
    //Bug was here: It was subtracting 1 from an unsigned integer and resetting the unsigned integer to a maximum value of 4294966604
    //but should be an integer so that the check of i >= 0 works correctly
	int i;
	for (i = size-1; i >= 0; i--) {
